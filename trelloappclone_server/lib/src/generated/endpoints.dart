...
class Endpoints extends _i1.EndpointDispatch {
  ...
  void initializeEndpoints(_i1.Server server) {
    ...
    connectors['attachment'] = _i1.EndpointConnector(
      ...
      methodConnectors: {
        'createAttachment': _i1.MethodConnector(
    ...
    connectors['card'] = _i1.EndpointConnector(
      ...
      methodConnectors: {
        ...
        'updateCrad': _i1.MethodConnector(
          name: 'updateCrad',
          params: {
            'card': _i1.ParameterDescription(
              name: 'card',
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['card'] as _i5.CardEndpoint).updateCrad(
            session,
            params['card'],
          ),
        ),
        ...
        'addComment': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['comment'] as _i7.CommentEndpoint).addComment(
            session,
            params['comment'],
          ),
        ),
    ...
    connectors['listboard'] = _i1.EndpointConnector(
      ...
      methodConnectors: {
        'createListboard': _i1.MethodConnector(
          name: 'createListboard',
          params: {
            'listboard': _i1.ParameterDescription(
              name: 'listboard',
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['listboard'] as _i9.ListboardEndpoint).createListboard(
            session,
            params['listboard'],
          ),
        ),
    ...
    connectors['workspace'] = _i1.EndpointConnector(
      ...
      methodConnectors: {
        ...
        'getWorkspacesById': _i1.MethodConnector(
          name: 'getWorkspacesById',
          params: {
            'workspaceId': _i1.ParameterDescription(
              name: 'workspaceId',
              type: _i1.getType<int>(),
