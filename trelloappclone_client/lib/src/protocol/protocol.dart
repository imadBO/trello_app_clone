...
import 'listboard.dart' as _i8;
import 'member.dart' as _i9;
import 'user.dart' as _i10;
import 'workspace.dart' as _i11;
import 'protocol.dart' as _i12;
import 'package:trelloappclone_client/src/protocol/listboard.dart' as _i13;
import 'package:trelloappclone_client/src/protocol/member.dart' as _i14;
import 'package:trelloappclone_client/src/protocol/user.dart' as _i15;
import 'package:trelloappclone_client/src/protocol/workspace.dart' as _i16;
import 'package:trelloappclone_client/src/protocol/board.dart' as _i17;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i8.Listboard) {
      return _i8.Listboard.fromJson(data, this) as T;
    }
    if (t == _i9.Member) {
      return _i9.Member.fromJson(data, this) as T;
    }
    if (t == _i10.User) {
      return _i10.User.fromJson(data, this) as T;
    }
    if (t == _i11.Workspace) {
      return _i11.Workspace.fromJson(data, this) as T;
    }
    ...
    if (t == _i1.getType<_i8.Listboard?>()) {
      return (data != null ? _i8.Listboard.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i9.Member?>()) {
      return (data != null ? _i9.Member.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i10.User?>()) {
      return (data != null ? _i10.User.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i11.Workspace?>()) {
      return (data != null ? _i11.Workspace.fromJson(data, this) : null) as T;
    }
    if (t == List<_i12.Card>) {
    ...
    if (t == List<_i13.Listboard>) {
      return (data as List).map((e) => deserialize<_i13.Listboard>(e)).toList()
          as dynamic;
    }
    ...
    if (t == _i1.getType<List<_i16.Workspace>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i16.Workspace>(e)).toList()
          : null) as dynamic;
    }
    if (t == List<_i17.Board>) {
      return (data as List).map((e) => deserialize<_i17.Board>(e)).toList()
          as dynamic;
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'Listboard') {
      return deserialize<_i8.Listboard>(data['data']);
    }
